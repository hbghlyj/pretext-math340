...
\begin{multicols}{2}
\begin{parts}
\part[4] $\displaystyle \left(\frac{2}{3}-\frac{1}{4}\right) \cdot \left(\frac{2}{5}+\frac{2}{3}\right)$
\vspace{2.25in}
\part[4] $\displaystyle  \frac{(-3)^2-(-2)^2}{-3^2-(-2^2-3)}$
\end{parts}
\addpoints
\end{multicols}
\vspace{4in}
%=======================================================================================================================
\addpoints
\question[6] Solve~~$\displaystyle \frac{1}{2}\left\vert -x + 1 \right\vert = 4$.
\vspace{4in}
%=======================================================================================================================
\question[15] Consider the line with the equation $-x + 2y -2 = 0$.
\noaddpoints
\begin{parts}
\part[6] Find the slope and the $y$-intercepts of the line above.
\vspace{1.5in}
\part[4] Determine whether the line $\displaystyle y -2 = -2(x+3)$ is parallel, perpendicular, or neither to the line above.  Explain your reasoning.
\vspace{1.75in}
\part[5] Graph the lines $-x + 2y -2 = 0$ and  $\displaystyle y -2 = -2(x+3)$. \emph{Clearly label two points on each line.}
...
\part[8] $\displaystyle 6 \geq 2\left\vert -1  + x \right\vert $

\vspace{2.5in}
\part[8] $\displaystyle 0 \leq 2x-1 < 3$
...
\begin{parts}
\begin{multicols}{2}
\part[5] $\displaystyle \frac{3}{2x} - \frac{y+1}{3xy}$
\vspace{4.2in}
\part[5] $\displaystyle \frac{1}{t - 1} - \frac{2}{t+2}$
\end{multicols}
\vspace{4.2in}
\end{parts}
\addpoints
...
\question[15] For the function $f(x)=2x^2-5x+3$, determine the following.
\noaddpoints
\vspace{2pt}
\begin{parts}
\part[2] $y$-intercept
...
\question[5] Find the restricted values of $\displaystyle \frac{x+3}{x^2+4x+3}$ and simplify the rational expression as much as possible.
\addpoints
\end{questions}
\end{document}
