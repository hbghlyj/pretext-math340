...
\part[5] $\displaystyle \sqrt{ \frac{4x^3y^6}{64x^7y^2} }$
\vspace{1.5in}

\part[5] $\sqrt[3]{8 x^9 y^3 z^{27}}$.
\vspace{2in}
\addpoints
\end{parts}
...
\vspace{2pt}
\begin{parts}
\part[10] $\displaystyle 2\sqrt{3}-\sqrt{27}$
\vspace{2in}
\part[10] $
\left(\sqrt{9x^6y^4}\right) \cdot \left(3x^3\sqrt{25x^2y^4}\right)$
\vspace{2in}
\end{parts}
\addpoints

\question[10] Divide the expression $(x^3-4x^2+3x+1)\div (x+2)$ and find the quotient and the remainder.
\addpoints
\vspace{3.2in}
