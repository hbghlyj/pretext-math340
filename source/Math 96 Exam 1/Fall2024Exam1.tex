...
\begin{parts}
\noaddpoints
\part[8] $\displaystyle \left(\frac{3}{4}-\frac{1}{2}\right) \div\left(\frac{5}{4}+\frac{1}{2}\right)$
\vspace{2.25in}
\part[7] $\displaystyle  \frac{2-(-3^2)}{-(-1)^2+(2-3)^3}$
\end{parts}
\addpoints
\end{multicols}
\vspace{3.5in}
\question[15] Solve the equation $\displaystyle \frac{1}{2}+\frac{3}{4}x = \frac{2}{3}$
\vspace{4in}
\addpoints
...
\question[15] Find the equation of the line in slope-intercept form that passes through the points $(2,-1)$ and $(1,-3)$.
\vspace{3.5in}

\newpage
\question[20] Consider the line with the equation $-x + 3y + 6=0.$
\noaddpoints
\begin{parts}
...
\vspace{1in}
\part[5] Determine whether the line $\displaystyle y - 6 = -\frac{1}{3}(x+3)$ is parallel, perpendicular, or neither to the line above.  Explain your reasoning.
\vspace{1.75in}
\part[5] Graph the line $-x + 3y + 6 = 0$. \emph{Clearly label two points on the line.}
\begin{figure}[ht]
\vspace{-12pt}
\centering
...
\question[10] Find three consecutive integers whose sum is 225.
\vspace{2.75in}
\question[15] A store is offering a 15\% discount on a jacket that originally costs \$120. 
