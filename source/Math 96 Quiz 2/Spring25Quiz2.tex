...
%=======================================================================================================================
\vspace{-10pt}
\question[8] Determine the solution set for the given inequality, express it in interval notation, and illustrate it graphically on a number line. 
\[-x +7 \leq -6x\]
...
\begin{parts}
\part[6] 
$\displaystyle \left\vert \frac{3}{4} x -2 \right\vert \leq 1$
\vspace{1.6in}
